...
<Dropdown dismissOnClick={false} className='sm:w-auto md:w-auto lg:w-auto w-full ' renderTrigger={() => <h1 className=''> Messages </h1> }>
...
<Button color='yellow' className='block h-full'> View </Button>
</div>
</Dropdown.Item>
</Dropdown>
   </li> 
...
<Dropdown dismissOnClick={false} className='sm:w-auto md:w-auto lg:w-auto w-full ' renderTrigger={() => <h1 className=''> Notifications </h1> }>
<h1 className='m-5 font-bold'>Notifications</h1>
  <div className="flex   justify-between px-2 py-1">   
<Badge color="gray" className='w-10 '> New </Badge>

<a href="/notification" className='text-sm hover:underline '>See all</a> </div>
<Dropdown.Item className='relative  '> 
<Avatar
alt="avatar of Jese"
img="https://images.unsplash.com/photo-1695033023233-6aae57417ddb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHx0b3BpYy1mZWVkfDF8SnBnNktpZGwtSGt8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
...
<Button color='yellow' className='block h-10 border-gray  ' >Decline</Button>
</div>
</div>
